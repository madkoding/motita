            ...
            <div class="tasks-body">
              ...
              <div class="tasks-form pt-4 border-t border-white/10 space-y-2">
                ...
                <div class="flex gap-2">
                  ...
                  />
                  {/* min-w-0 on BOTH halves of the row: a flex item's automatic minimum size is its
                      longest word, and a <select> is a replaced element whose text and arrow give
                      it a real min-content width - wide enough ("Plan (read-only)") that the row
                      was 3px past the form and grew a horizontal scrollbar over the whole left
                      column. The select keeps its intrinsic width while the column is wide enough,
                      and gives way before pushing anything out of the card. */}
                  <select
